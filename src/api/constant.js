...
export const PUSHNOTIFICATION = `${URL}/pushnotification`;
export const ACTIVEACOUNT = `${URL}/payment/active-payment`;
export const ACCOUNTACTIVET = `${URL}/payment/account-activation`;
